...
gdjs.input_32scene6Code.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(13474900);
}
...
{for(var i = 0, len = gdjs.input_32scene6Code.GDBlueButtonObjects2.length ;i < len;++i) {
    gdjs.input_32scene6Code.GDBlueButtonObjects2[i].getBehavior("Tween").addObjectScaleTween("Hover", 1.55, 1.05, "bouncePast", 100, false, true);
}
for(var i = 0, len = gdjs.input_32scene6Code.GDGreyButtonObjects2.length ;i < len;++i) {
    gdjs.input_32scene6Code.GDGreyButtonObjects2[i].getBehavior("Tween").addObjectScaleTween("Hover", 1.55, 1.05, "bouncePast", 100, false, true);
}
for(var i = 0, len = gdjs.input_32scene6Code.GDYellowButtonObjects2.length ;i < len;++i) {
    gdjs.input_32scene6Code.GDYellowButtonObjects2[i].getBehavior("Tween").addObjectScaleTween("Hover", 1.55, 1.05, "bouncePast", 100, false, true);
}
}}
...
{for(var i = 0, len = gdjs.input_32scene6Code.GDBlueButtonObjects2.length ;i < len;++i) {
    gdjs.input_32scene6Code.GDBlueButtonObjects2[i].getBehavior("Tween").addObjectScaleTween("Press", 1.45, 0.95, "easeOutQuad", 50, false, true);
}
for(var i = 0, len = gdjs.input_32scene6Code.GDGreyButtonObjects2.length ;i < len;++i) {
    gdjs.input_32scene6Code.GDGreyButtonObjects2[i].getBehavior("Tween").addObjectScaleTween("Press", 1.45, 0.95, "easeOutQuad", 50, false, true);
}
for(var i = 0, len = gdjs.input_32scene6Code.GDYellowButtonObjects2.length ;i < len;++i) {
    gdjs.input_32scene6Code.GDYellowButtonObjects2[i].getBehavior("Tween").addObjectScaleTween("Press", 1.45, 0.95, "easeOutQuad", 50, false, true);
}
}}
...
{
{gdjs.input_32scene6Code.conditionTrue_1 = gdjs.input_32scene6Code.condition0IsTrue_0;
gdjs.input_32scene6Code.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(13479532);
}
}if (gdjs.input_32scene6Code.condition0IsTrue_0.val) {
...
{for(var i = 0, len = gdjs.input_32scene6Code.GDPointObjects1.length ;i < len;++i) {
    ...
    gdjs.input_32scene6Code.GDTitleObjects1[i].setString("Friction Coefficient of This Floor : " + gdjs.evtTools.string.newLine() + "         - µk & - µs");
}
...
/* Reuse gdjs.input_32scene6Code.GDYellowButtonObjects1 */
{for(var i = 0, len = gdjs.input_32scene6Code.GDBlueButtonObjects1.length ;i < len;++i) {
    gdjs.input_32scene6Code.GDBlueButtonObjects1[i].getBehavior("Tween").addObjectScaleTween("Default", 1.5, 1, "bouncePast", 100, false, true);
}
for(var i = 0, len = gdjs.input_32scene6Code.GDGreyButtonObjects1.length ;i < len;++i) {
    gdjs.input_32scene6Code.GDGreyButtonObjects1[i].getBehavior("Tween").addObjectScaleTween("Default", 1.5, 1, "bouncePast", 100, false, true);
}
for(var i = 0, len = gdjs.input_32scene6Code.GDYellowButtonObjects1.length ;i < len;++i) {
    gdjs.input_32scene6Code.GDYellowButtonObjects1[i].getBehavior("Tween").addObjectScaleTween("Default", 1.5, 1, "bouncePast", 100, false, true);
}
}}
