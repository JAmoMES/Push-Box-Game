...
gdjs.input_32scene5Code.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(13449844);
}
...
{
{gdjs.input_32scene5Code.conditionTrue_1 = gdjs.input_32scene5Code.condition0IsTrue_0;
gdjs.input_32scene5Code.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(13454476);
}
}if (gdjs.input_32scene5Code.condition0IsTrue_0.val) {
...
{for(var i = 0, len = gdjs.input_32scene5Code.GDPointObjects1.length ;i < len;++i) {
    ...
    gdjs.input_32scene5Code.GDTitleObjects1[i].setString("Friction Coefficient of This Floor : " + gdjs.evtTools.string.newLine() + "         - µk & - µs");
}
